    ...
    >
      ...
      <div className="space-y-4">
        <div className="grid grid-cols-2 gap-3">
          ...
          <div className="bg-[#050816]/50 rounded-xl p-3 border border-blue-900/20">
            <div className="text-slate-500 text-[10px] mb-1 uppercase tracking-wider font-medium">Avg Package</div>
            <div className="text-emerald-400 font-bold text-base">
              {college?.avg_package ? `₹${college.avg_package}L` : 'N/A'}
            </div>
          </div>
        </div>
        ...
        <div className="grid grid-cols-2 gap-3">
          <div className="bg-[#050816]/50 rounded-xl p-3 border border-blue-900/20">
            <div className="text-slate-500 text-[10px] mb-1 uppercase tracking-wider font-medium">Yearly Fees</div>
            <div className="text-white font-bold text-base">
              {college?.fees_per_year ? `₹${(college.fees_per_year / 100000).toFixed(1)}L` : 'N/A'}
            </div>
          </div>
          <div className="bg-[#050816]/50 rounded-xl p-3 border border-blue-900/20">
