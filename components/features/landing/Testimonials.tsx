...
const testimonials = [
  {
    quote: "I stopped opening 20 tabs during JoSAA counselling. RankPilot JEE gave me everything in one place — cutoffs, fees, placements, and my optimized choice list.",
    name: "Arjun Sharma",
  ...
  {
    quote: "As a parent, I was completely lost about JoSAA. RankPilot JEE made it simple to understand which colleges were realistic for my son's rank and which were dream options.",
    name: "Sunita Gupta",
  ...
  {
    quote: "Used the choice filling assistant to build my entire JoSAA list. RankPilot JEE reordered my choices by ROI score — got admitted in Round 2.",
    name: "Deepak Patel",
