    ...
    <section className="py-20 px-4 sm:px-6 lg:px-8 relative overflow-hidden">
      ...
      <div className="max-w-3xl mx-auto text-center relative z-10">
        ...
        >
          ...
          <div className="w-12 h-12 rounded-xl bg-blue-600/20 border border-blue-500/30 flex items-center justify-center mx-auto mb-5 glow-blue">
          ...
          <p className="text-slate-400 text-sm mb-8 max-w-md mx-auto">
            Join 50,000+ students who used RankPilot to make data-driven college decisions.
